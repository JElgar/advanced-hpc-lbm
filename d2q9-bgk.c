...
int propagate_and_rebound(const t_param params, t_speed* cells, t_speed* tmp_cells, t_speed* tmp_cells2, char* obstacles);
...
int timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, t_speed* tmp_cells2, char* obstacles)
{
  ...
  propagate_and_rebound(params, cells, tmp_cells, tmp_cells2, obstacles);
